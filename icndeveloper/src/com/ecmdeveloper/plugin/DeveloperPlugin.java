 ...
 * <p>
 */
public class DeveloperPlugin extends Plugin {
	...
	public String getName(Locale locale) {
		return "Content Navigator Developer Plugin";
	}
	...
	public String getConfigurationDijitClass() {
		return "developerPluginDojo.ConfigurationPane";
	}
	...
	public com.ibm.ecm.extension.PluginAction[] getActions() {
		return new com.ibm.ecm.extension.PluginAction[]{new com.ecmdeveloper.plugin.action.ShowSecurityAction()};
	}
	...
	public com.ibm.ecm.extension.PluginService[] getServices() {
		return new com.ibm.ecm.extension.PluginService[]{new com.ecmdeveloper.plugin.service.ShowSecurityService()};
	}
