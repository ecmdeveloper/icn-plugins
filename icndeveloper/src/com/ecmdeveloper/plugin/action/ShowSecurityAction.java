package com.ecmdeveloper.plugin.action;
 ...
 */
public class ShowSecurityAction extends PluginAction {
	...
	public String getActionModelClass() {
		return "developerPluginDojo.ShowSecurityAction";
	}
